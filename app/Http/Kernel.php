...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareAliases = [
        ...
        "internationalize" => \App\Http\Middleware\Internationalize::class,
        "user.admin" => \App\Http\Middleware\EnsureUserIsAdmin::class,
        "user.distributor" => \App\Http\Middleware\EnsureUserIsDistributor::class,
        "user.stockist" => \App\Http\Middleware\EnsureUserIsStockist::class,
        "user.loggedIn" => \App\Http\Middleware\EnsureUserIsLoggedIn::class,
        "sponsor.valid" => \App\Http\Middleware\EnsureReferralTokenIsValid::class,
