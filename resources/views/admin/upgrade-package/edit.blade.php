                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="d-inline-block" tabindex="0" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-content="{{ __("view") }}">
                                        ...
                                        <button class="action-btn text-secondary edit-btn" onclick="setFormAction('/{{ App::getLocale() }}/admin/upgrade-packages/{{ $product->pivot->id }}/product')"
                                    ...
                                    <span class="d-inline-block" tabindex="0" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-content="{{ __("view") }}">
                                        <button class="action-btn text-danger" onclick="setDeleteFormAction('/{{ App::getLocale() }}/admin/upgrade-packages/{{ $product->pivot->id }}/product')"
