                    ...
                    <tbody>
                        @foreach($transfers as $transfer)
                            <tr>
                                ...
                                <td>{{ $transfer->distributor->user->id }}</td>
                                <td>{{ $transfer->distributor->user->name }}</td>
                                ...
                                <td>
                                    @if ($transfer->status === "COMPLETE")
                                        <span class="d-inline-block" tabindex="0" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-content="{{ __("reverse_transfer") }}">
                                            <button onclick="setFormAction('/{{App::currentLocale()}}/admin/distributors/{{ $transfer->id }}/reverse-transfer')"
