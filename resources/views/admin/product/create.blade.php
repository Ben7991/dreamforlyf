<x-layout.admin>
    ...
    <div class="d-block d-md-flex align-items-center justify-content-between mb-4">
        <h4 class="mb-2 mb-md-0">{{ __("add") }} {{ __("product") }}</h4>
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-8 col-xxl-9">
                <div class="border bg-white rounded shadow-sm p-3">
                    ...
                    <form action="/{{App::getLocale()}}/admin/products" method="POST" id="form"
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="number" name="bv_point" id="bv_point" class="form-control">
                            <small class="text-danger d-none"></small>
                        </div>
                        <input type="file" name="image" id="image" class="form-control d-none" accept="image/jpeg, image/jpg, image/png">
                        <div class="form-group mb-3">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="hidden" name="description_fr" id="description_fr">
                        </div>
