<x-layout.distributor>
    ...
    <div class="d-block d-md-flex align-items-center justify-content-between mb-3">
        <div class="d-flex align-items-center justify-content-between mb-2 gap-3">
            <h4 class="mb-0">Complan</h4>
            <a
                href="{{ App::currentLocale() === 'en' ? asset('assets/complan/complan-english.pptx') : asset('assets/complan/complan-french.pptx')  }}"
                class="btn btn-success">
                <i class="bi bi-cloud-download-fill"></i> {{__("download_complan")}}
            </a>
        </div>
